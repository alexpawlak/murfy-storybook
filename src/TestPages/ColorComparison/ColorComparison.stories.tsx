...
const verticals: VerticalData[] = [
  ...
  },
  {
    ...
    contrastBefore: null,
    contrastAfter:  { ratio: '12.32:1', rating: 'AAA', textColor: '#032524' },
    changes: [
      'Le CTA utilise maintenant #FFDE73 comme couleur par defaut pour rapprocher le bouton du highlight solaire.',
      'Le hover du bouton revient sur #FFD800 pour conserver une progression d interaction plus marquee.',
      'Le highlight passe a #FFF3BF pour rester plus leger que le CTA et eviter de confondre decoratif et action.',
    ],
    proposedTokens: [
      { name: 'yellow-btn-bg', value: '#FFDE73', note: 'fond CTA solaire par defaut' },
      { name: 'yellow-500', value: '#FFD800', note: 'etat hover du CTA solaire' },
      { name: 'yellow-highlight', value: '#FFF3BF', note: 'pill / surface teintee plus claire que le bouton' },
    ],
    note: 'Le CTA Solaire gagne en douceur visuelle tout en ameliorant le contraste (12.32:1 AAA). Le hover reste plus soutenu, et le highlight devient plus clair pour conserver une hierarchie nette.',
  },
  {
    id: 'formation',
    vertical: 'Formation',
