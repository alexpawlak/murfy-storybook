...
export function FaqSection({ heading, subheading, body, items }: FaqSectionProps) {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[57fr_43fr] gap-10 md:gap-16 items-start">

        {/* Left — FAQ accordion list (forced light so cards stay white) */}
